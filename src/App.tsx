...
const AppHeader = () => (
  <div
    style={{ position: "sticky", top: 0, zIndex: 10, background: "#fcf0f0ff" }}
  >
    <Header
      style={{
...
const AppContent = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      checkForUpdates({ force: false, messageApi, modalApi });
    }, 1000);
    ...
    >
      ...
      >
        <Routes>
          ...
          <Route
            path="/setting/cache/playlist/:playlistId"
            element={<PlaylistCacheManagePage />}
          />
        </Routes>
      </Content>
